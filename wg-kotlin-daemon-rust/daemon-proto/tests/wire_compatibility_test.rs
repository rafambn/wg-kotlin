use prost::Message;
use daemon_proto::pb::DnsConfig;

const DNS_CONFIG_FIXTURE: &[u8] = &[
    0x0a, 0x07, 0x31, 0x2e, 0x31, 0x2e, 0x31, 0x2e, 0x31, 0x12, 0x0c, 0x63, 0x6f, 0x72, 0x70, 0x2e,
...
fn dns_fixture_decodes_and_reencodes() {
    ...
    assert_eq!(decoded.servers, vec!["1.1.1.1".to_string()]);
